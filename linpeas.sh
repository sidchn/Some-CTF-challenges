...
print_banner(){
  ...
  echo "     ;5;108m     ;5;59m ;5;71m ;5;77m       ;5;22m ;5;108m   ;5;114m ;5;59m m
     ;5;108m  ;5;71m ;5;22m ;5;113m ;5;71m ;5;94m ;5;214m  ;5;58m ;5;214m    ;5;100m ;5;71m  ;5;16m ;5;108m  m
     ;5;65m ;5;16m ;5;22m ;5;214m      ;5;16m ;5;214m        ;5;65m  m
     ;5;65m ;5;214m       ;5;16m ;5;214m ;5;16m ;5;214m       ;5;136m ;5;65m m
     ;5;23m ;5;214m          ;5;178m ;5;214m       ;5;65m m
     ;5;16m ;5;214m         ;5;136m ;5;94m   ;5;136m ;5;214m    ;5;65m m
     ;5;58m ;5;214m  ;5;172m ;5;64m ;5;77m             ;5;71m ;5;65m m
     ;5;16m ;5;71m ;5;77m  ;5;71m ;5;77m         ;5;71m ;5;77m   ;5;65m  m
     ;5;59m ;5;71m ;5;77m ;5;77m ;5;16m ;5;77m         ;5;16m ;5;77m   ;5;65m  m
     ;5;65m  ;5;77m      ;5;71m ;5;16m ;5;77m    ;5;113m ;5;77m   ;5;65m  m
     ;5;65m ;5;16m ;5;77m  ;5;150m ;5;113m ;5;77m        ;5;150m ;5;113m ;5;77m ;5;65m ;5;59m ;5;65m m
     ;5;16m ;5;65m ;5;71m ;5;77m             ;5;71m ;5;22m ;5;65m  m
     ;5;108m  ;5;107m ;5;59m ;5;77m           ;5;16m ;5;114m ;5;108m   m"
    fi
}
...
if [ "`echo $CHECKS | grep ProCronSrvcsTmrsSocks`" ]; then
  ...
  for s in `ss -xlp -H state listening 2>/dev/null | grep -Eo "/.* " | cut -d " " -f1`; do
    ...
    if [ $? -eq 0 ]; then
      ...
      echo "Socket $s owned by $owner uses HTTP. Response to /index:" | sed "s,$sh_usrs,${C}[1;96m&${C}[0m,g" | sed "s,$USER,${C}[1;95m&${C}[0m,g" | sed "s,$nosh_usrs,${C}[1;34m&${C}[0m,g" | sed "s,$knw_usrs,${C}[1;32m&${C}[0m,g" | sed "s,root,${C}[1;31m&${C}[0m," | sed "s,$knw_grps,${C}[1;32m&${C}[0m,g" | sed "s,$groupsB,${C}[1;31m&${C}[0m,g" | sed "s,$groupsVB,${C}[1;31m&${C}[0m,g" | sed "s,$idB,${C}[1;31m&${C}[0m,g"
      echo "$socketcurl"
    fi
  done
  echo ""
...
if [ "`echo $CHECKS | grep UsrI`" ]; then
  ...
  (id || (whoami && groups)) 2>/dev/null | sed "s,$sh_usrs,${C}[1;96m&${C}[0m,g" | sed "s,$USER,${C}[1;95m&${C}[0m,g" | sed "s,$nosh_usrs,${C}[1;34m&${C}[0m,g" | sed "s,$knw_usrs,${C}[1;32m&${C}[0m,g" | sed "s,root,${C}[1;31m&${C}[0m," | sed "s,$knw_grps,${C}[1;32m&${C}[0m,g" | sed "s,$groupsB,${C}[1;31m&${C}[0m,g" | sed "s,$groupsVB,${C}[1;31;103m&${C}[0m,g" | sed "s,$idB,${C}[1;31m&${C}[0m,g"
  echo ""
...
if [ "`echo $CHECKS | grep SofI`" ]; then
  ...
  printf $Y"[+] "$GREEN"Looking for Drupal settings.php files\n"$NC
